...
import { getTrackingItem, getOrder, STORE_WHATSAPP_NUMBER } from '../services/firebase';
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 border border-slate-100 animate-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="md:col-span-2 border-t border-slate-100 pt-6 flex justify-center">
              <a href={`https://wa.me/${STORE_WHATSAPP_NUMBER}?text=Olá, gostaria de falar sobre o pedido ${orderData.id}`} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-8 py-4 bg-[#25D366] hover:bg-[#1ebd5b] text-white rounded-2xl font-black transition-all shadow-lg shadow-green-500/20 active:scale-95">
